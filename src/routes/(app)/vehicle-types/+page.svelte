<script>
    import { Button, TableBody, TableHead, Tables, Dropdown, TextInput } from "$lib/Components";
    import {
        MoreHorizontal,
        Download,
    } from "lucide-svelte";
    ...
    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        <thead class="bg-gray-50 dark:bg-slate-800">
            <tr>
                ...
                <TableHead name="Post Name" classes="px-6 py-3 text-start" />
            ...
            <tr>
                ...
                <TableBody
                    ...
                    >
                        ...
                        <Dropdown
                            over="hs-edit-vType-modal"
                            del="hs-del-vType-modal"
